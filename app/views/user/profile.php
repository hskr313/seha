<div class="container"> <!-- Conteneur principal -->
    <div class="card mb-4"> <!-- Carte contenant le profil de l'utilisateur -->
        ...
        <div class="card-body"> <!-- Corps de la carte -->
            <form id="profileForm" method="POST" action="/seha/public/user/updateProfile"> <!-- Formulaire pour mettre à jour le profil -->
                <div class="row"> <!-- Ligne contenant les informations du profil -->
                    <div class="col-lg-6"> <!-- Colonne gauche -->
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username" class="form-control-plaintext" value="<?php echo $user->username; ?>" readonly> <!-- Champ de texte pour le nom d'utilisateur, en mode lecture seule -->
                        </div>
                        <div class="form-group">
                            <label for="email"><strong>Email:</strong></label> <!-- Étiquette pour l'email -->
                            <input type="email" id="email" name="email" class="form-control-plaintext" value="<?php echo $user->email; ?>" readonly> <!-- Champ de texte pour l'email, en mode lecture seule -->
                        </div>
                        <div class="form-group">
                            <label for="time_credit"><strong>Time Credit:</strong></label> <!-- Étiquette pour le crédit temps -->
                            <input type="text" id="time_credit" class="form-control-plaintext" value="<?php echo $user->time_credit; ?>" readonly> <!-- Champ de texte pour le crédit temps, en mode lecture seule -->
                        </div>
                    </div>
                ...
                <div id="editButtons" class="mt-3 d-none"> <!-- Boutons de sauvegarde et d'annulation, cachés par défaut -->
                    ...
                    <button type="button" class="btn btn-secondary" onclick="cancelEdit()">Cancel</button> <!-- Bouton d'annulation -->
                </div>
                <a href="javascript:void(0)" class="btn btn-primary mt-3" id="editProfileBtn" onclick="editProfile()">Edit Profile</a> <!-- Bouton pour entrer en mode édition -->
            </form>
        </div>
    </div>
</div>
